...
, cte2 as (
select sub_category,
sum(case when order_year=2022 then sales_profit else 0 end) as profit_2022,
sum(case when order_year=2023 then sales_profit else 0 end) as profit_2023
from cte 
group by sub_category)
select top 1 * ,(profit_2023-profit_2022) profit_growth
from  cte2
